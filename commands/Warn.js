                ...
                if(newLv > 4 && newLv < 10){
                    try{
                        ...
                        try{
                            ...
                            let newErr = e.toString();
                            if(newErr.match("Missing Permissions")){
                                bErr = 1;
                                logColour = '#ff6666';
                                logDescriptionArr.push(`${target.user.username} cannot be banned. Missing permissions or they have a higher rank.`);
                            }
                        }
                    }catch(e){
                        bErr = 1;
